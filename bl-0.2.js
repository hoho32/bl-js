																			   ...
																			   var o = document.createElement("script"),
																				...
																				o.id = "scrp", i.id = "styl", o.innerHTML = bl("#code2").innerText, i.innerHTML = bl("#code3").innerText, doc.open(),  doc.writeln("<body></body>"),doc.writeln(bl("#code").innerText), void 0 !== doc.children[0] && ( /*doc.children[0].children[0].children[0].outerHTML = document.getElementById("ho_ho").outerHTML,*/ doc.children[0].children[0].appendChild(i), void 0 === doc.children[0].children[1] && doc.children[0].appendChild(doc.createElement("body"))), doc.close();
																				   ...
																				   /* insert strings into DOM
																																						  ...
																																						  // console.log("allah")
																																						   var htmlContent = ''
																																						   htmlContent += '<script src="http://bl-js.com/bl_js/bl-0.2.js"><\/script>'
...
//console.log("... "+c[2][1]+" __ "+c[2][0])
													  ...
													  o=c[2][3][0]-1;
														 ...
														 {//console.log("else__")
															  ...
															  o = 0 == c[2][3][3] ? c[2][3][0] - 1 : c[2][3][0] - c[2][3][3] - 1}
																...
																sIT(e,  o * c[2][3][2], c[2][3][1],1, 1, c[2][0])	 
																 }else
																	 sIT(e,  c[2][3][0], c[2][3][1], 1,1, c[2][0]);
																// "∞" !== c[2][3][2] ? sIT(e,  o * c[2][3][2], c[2][3][1],1, 1, c[2][0]) : sIT(e,  c[2][3][2], c[2][3][1], 1,1, c[2][0])
																					  } else e[0](e[1], e[2], e[e.length - 1]);
																				var ll=false;	  
																				  1 === n && ("set" === e[0].name ? (p = e[1][1], d = e[1][1][2][2],ll="∞" === l, (p[2][0].length === s.length && p[2][0] === s )? ("0" === p[2][0][p[2][0].length - 1] ? (/*console.log(".0 + " + p[2][0]),*/p[2][0] = s= "0", p[2][3][3]++/*, console.log("0 + " + p[2][0])*/) : (/*console.log(".1 - " + p[2][0]),*/p[2][0] = s = "1", p[2][3][3]--/*, console.log("1 - " + p[2][0])*/), "function" == typeof p[2][4] ? (a = p[2][4](p[2][1], d[0],e[1][0]), p[2][1] = a[0], d[0] = a[1]) : "+" === p[2][1] && (ll || d[0] < (l+1)) ? d[0]++ : (d[0]--, p[2][1] = "-", -1 === d[0] && (d[0]+=2, p[2][1] = "+")), e[0](e[1][0], p[0], p[1], d)) : clearInterval(i)) : e[0]("obj", e[1]))
																			  } else{ //alert(t)
						...
						//console.log("style2")						   
												 ...
												 var _sit,val_=[0],valF_,fois=1, bolCent;
    ...
    if(_bb=="noAnmt" && pSV2[psv].match(/-/)!=null)
                        ...
                        //  console.log(sN)
											...
											/* function animate(e, t, l, r) {
											 ...
											 function anmt() {
					  var bolF=false;
												 for (var e, t = [,,[10,100,1,0]],count=0,  r = 0; r < arguments.length; r++)
												 {
		 ...
		 //alert(e);
                         ...
                         //console.log("jadid "+r+" "+l)
													 var n = void 0 !== e ? e : 10,
														 s = void 0 !== t ? t : -1;
													 return "+" === l && (n===true|| n > r)? r++ : (r--, l = "-", r ==s && (r+=2, l = "+")),/*console.log("jadid2 "+r+" "+l), */[l, r]
												 }
												 return l
											 }
													  ...
													  function fev() {
														  function e() {
															  function e() {
																  ...
																  i = -1 === i ? n.length - 1 : i, r.setAttribute("src", "https://noPic"), style(r, "z-index", "0", "now"), cEv1 = cEv1 === l ? 0 : cEv1;
