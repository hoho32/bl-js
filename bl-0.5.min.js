...
function treeView(a){
if(a !="run"  )
	{bl("button.button.small-button",0,addRoot(".gAll0","gTxt",0,20," RoOt"))
	   bl("button.button.small-button",1,addLeafC("gTxt","gChek","c",0))
	   bl("button.button.small-button",2,addLeafC("gTxt","gRadio","r",10))}else{
	   tV();return ;
	   }
   ...
   // bl(e,m).prototype.changeColor =b; 
    ...
    // var ele_;  
      if(el.parentElement.nextSibling.radio_ && !el.cHek /*jadido*/ ){
			   el.cHek2 =true;bl(el.cHekF2[0],el.cHekF2[1],el.cHekF2[2],el.cHekF2[3]);
         bl(style(el.cHekF2[4][0],"fill","blue",sIT(560,0,1)),style(el.cHekF2[4][1],"fill","blue",sIT(560,0,1)));}
        
		   var j=isO(bl(elStr+" .gChek #chek")),jj;
		   j!=undefined && (jj=j.length);
           /*jadid
        var ele_= el.parentElement.parentElement;
          if(ele_.radio_ && !el.cHek ){
			   el.cHek2 =true;bl(el.cHekF2[0],el.cHekF2[1],el.cHekF2[2],el.cHekF2[3]);
         bl(style(el.cHekF2[4][0],"fill","blue",sIT(560,0,1)),style(el.cHekF2[4][1],"fill","blue",sIT(560,0,1)));}
         /*jadid*/
         ...
         j[i].cHek =el.cHek;bl(j[i].cHekF);bl(j[i].cHekFun);
          ...
          if(j[i].parentElement.nextSibling.radio_ && !j[i].cHek /*jadido*/){
			   j[i].cHek2 =true;bl(j[i].cHekF2[0],j[i].cHekF2[1],j[i].cHekF2[2],j[i].cHekF2[3]);
         bl(style(j[i].cHekF2[4][0],"fill","blue",sIT(560,0,1)),style(j[i].cHekF2[4][1],"fill","blue",sIT(560,0,1)));}
       else
			   if(j[i].cHek2){
						 j[i].cHek2=false;
  ...
  // var parRad=bl(e,m).parentElement;  //jadid
  // ele.radio_ =false;//jadid
				// el.nextSibling.getAttribute("class").replace(/ /g,".")
	   allCh(ele)
				 }
		  
		   
		 function allCh(a,parRad)  {
		  ...
		  if(d!=undefined && (dd=d.getAttribute("class")).search('gChek')!=-1 ) 
		   ...
		   if(jjBol ){
			 ...
			 if(!elStr2.cHek2){
			   elStr2.cHek2 =true;bl(elStr2.cHekF2[0],elStr2.cHekF2[1],elStr2.cHekF2[2],elStr2.cHekF2[3]);bl(style(elStr2.cHekF2[4][0],"fill","blue",sIT(560,0,1)),style(elStr2.cHekF2[4][1],"fill","blue",sIT(560,0,1)));}
         else if(jjj==jj /*jadido*/&& !a.radio_/*jadido*/){
   ...
   bl(e,m,bl(e,m).cHekFr(bl(e,m),h));
	 ...
	 //bl(e,m,style(bl(e+0,m,e+1,m),"fill",color[n],sIT(560,0,0)))
	  ...
	  if( bl(e+">.gRadio")!=undefined){ 
		function xrf(ix,tr,tf,parCheck_){
		  function xrf2(){  
      var parCheck=  parCheck_;
            if(!parCheck.parentElement.radio_/*jadido*/)
        {     parCheck.parentElement.radio_=true;
         //if(!parCheck.parentElement.previousSibling.children[0].cHek){   
        while((parCheck=parCheck.parentElement).getAttribute("class").search('RoOt')==-1){ 
               parCheck.radio_=true;
      // alert(parCheck.radio_ )  ;
       var ele_;
       if((ele_=parCheck.previousSibling.children) && !ele_[0].cHek)
        { ele_=ele_[0];
         
         if(ele_.getAttribute("class").toUpperCase().search("RADIO")==-1 && !ele_.cHek2 && !ele_.cHek2 ){
			   ele_.cHek2 =true;bl(ele_.cHekF2[0],ele_.cHekF2[1],ele_.cHekF2[2],ele_.cHekF2[3]);
         bl(style(ele_.cHekF2[4][0],"fill","blue",sIT(560,0,1)),style(ele_.cHekF2[4][1],"fill","blue",sIT(560,0,1)));}
   ...
   //bl(par,i,b);
	 ...
	 tabR.push(animate(bl(par+">#radio"+1,i),anmt("transform",pp,60,10,ho(51)),rr,1));
	  ...
	  bl(par,i,xrf(i+1,tabR,tabF/*jadido*/,parCheck.children[0]/*jadido*/)); 
 ...
 //e[1][0].parentElement.children[0].children[1].setAttribute("height",e[1][0].parentElement.getBoundingClientRect().bottom-e[1][0].parentElement.getBoundingClientRect().top-4);
...
function addRoot(a,b,x,y,r,n_){
 ...
 //bl(iHtml(bl(a),0,"+='"+bl(b).outerHTML+"'"));
  ...
  bl(a).innerHTML+=bl(".gAll .gTxt").outerHTML.replace("gTxt","gTxt"+RoOt+nn).replace("Root",LI);//+'<g><line x1="10" y1="10" x2="85" y2="10" style="stroke: #eff313;"></line><rect x="10" y="20" height="50" width="75" style="stroke: yellow;fill: yellow;"></rect></g>';
...
el.parentNode.replaceChild(elClone, el);
 ...
 ar_(".gAll0 .gArrow path"); 
         call_lineRect();
   function call_lineRect(){
         var j=isO(bl(".gAll0 .gTxt"/*:not(.RoOt)"*/)),jj=j.length,color,a,b,c,x=0,widt;
            for (var m=0;m< jj;m++){
       // el= j[m];  
       // console.log( j[m].getBoundingClientRect().width);
       // bl(iHtml(e.target.parentElement,0,'<g><line x1="10" y1="10" x2="85" y2="10" style="stroke: #eff313;"></line><rect x="10" y="20" height="50" width="75" style="stroke: yellow;fill: yellow;"></rect></g>'));
         if(10 * x + 60>255||10 * x + 60>255||10 * x + 60>255) 
         x=0
       // color="rgb(" + (10 * x + 60) + ", " + (5 * x + 132) + ", " + (10 * x + 145) + ")"
        color="rgb(" + (10 * x + 14) + ", " + (5 * x + 185) + ", " + (10 * x + 2) + ")" 
        if(j[m].parentElement.getAttribute("class").search("RoOt")!=-1)
        widt=300 ;
        else
        widt= j[m].children[0].getBoundingClientRect().width;
       j[m].insertAdjacentHTML("afterbegin", '<g><line x1="0" y1="-18" x2="'+j[m].children[0].getBoundingClientRect().width+'" y2="-18" style="stroke: black;"></line><rect x="0" y="-18" height="'+j[m].children[0].getBoundingClientRect().height+'" width="'+widt+'" style="stroke: '+color+';fill: '+color+';"></rect></g>');
        x++;
        }
     }
}
function fs(cl){
  function fs2(e){
   // var cl=e.target.getAttribute("class"); 
        if (e.target.tagName.toUpperCase().search("TEXT")==-1 && e.target.tagName.toUpperCase().search("PATH")==-1) 
     //if (e && e.target !== this)
    ...
    if(bl(".Z")!=undefined &&  cl2!=undefined && cl2.search(" ")!=-1)
 ...
 function movAnmt(e,m,bolThs){
   function xx(z,el,fin,bolThs) {
    ...
    function ch(e,l,r) {
      ...
      if(l.trim()=="+")
      posNeg=2 
          /*   var elem=e[1][0].parentElement.children[0].children[1]; 
             var elem2=el.parentElement.children[0].children[1];
      if(elem!=undefined) */ 
    /*  elem.setAttribute("height",e[1][0].parentElement.getBoundingClientRect().bottom-e[1][0].parentElement.getBoundingClientRect().top-4);
 el.children[0].children[1].setAttribute("height",el.getBoundingClientRect().bottom-el.getBoundingClientRect().top-4);
     */
            /*
               elem.setAttribute("height",e[1][0].parentElement.getBoundingClientRect().height-4);
               if(elem2!=undefined) 
               elem2.setAttribute("height",el.parentElement.getBoundingClientRect().height-4); */
                 var elem=el;
                while((elem=elem.parentElement)&&(rect=elem.children[0].children[1])!=undefined){ 
                 
               rect.setAttribute("height",elem.getBoundingClientRect().height-posNeg); 
               //else bol=false;
                }
               
 el.children[0].children[1].setAttribute("height",el.getBoundingClientRect().height-posNeg);
         
      vv=gS(el, "transform_matrix".split("_"))[0][1]
      vv=nOc(vv,5);
      v=gS(e[1][0], "transform_matrix".split("_"))[0][1]
      v=nOc(v,5);
       if(e[1][1][1][1][5]!=v){ //if(e[1][1][1][1][5]!=v || e[1][1][2][3][0]!=z[0]){ 
      ...
      if(fin!=undefined)
     {
      ...
      if(r==0||r==e[1][1][2][3][0]){
         //alert("--- "+fin[0]+" "+e[1][1][2][3][0]);
        bolThs[0]=false;
        bl(style(bl(".gArrow path"),"cursor","pointer"));  
          el.setAttribute("class",el.getAttribute("class").replace(/ tHiS/g,""))}//console.log("+++++ "+fin[0]+" "+ e[1][1][2][3][3]);
     }
  ...
  eval("e[1][1][1][1][5]=e[1][1][1][1][5]"+e[1][1][2][1]+"(-e[1][1][1][2][5])");
     return ""; 
      ...
      //  z=22*zz;
       ...
       var b=[],z=[]/*,fin=[]*/;
       z[0]=z[1]=(el.getBoundingClientRect().height-22)/2;
      ...
      // z[1]=el.children.length  ;
       ...
       function jdid(b,nx,el,z,fin,bolThs){
          ...
          function jdid2(){
           // var bolThs=[false];  
           var z_; 
            z[0]=(el.getBoundingClientRect().height-22)/2;
            for (var i = 0,ii=b.length; i < ii; i++)
             {
             if(i==0)
       {
      ...
      v=nOc(v,5);
       ...
       /* console.log(el.getBoundingClientRect())
        console.log(nx.getBoundingClientRect()) */
       }  else {//if(i ==ii-1)fin[0]= z[0];
